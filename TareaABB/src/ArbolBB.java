...
public class ArbolBB {
    ...
    public void insertarElemento(Integer value) {
        ...
        // Incrementamos el n�mero de elementos en 1
        numeroElementos++;
    ...
    public Integer buscarElemento(Integer value) {
        ...
        while (aux != null) {
            ...
            if (aux.getValue() == value) {
                ...
                // Si hemos llegado a un nodo hoja el elemento no est� en el ABB
                // El elemento no est�
                aux = null;
            } else if (value > aux.getValue() && aux.getDer() != null) {
    ...
    public boolean eliminarElemento(Integer value) {
        ...
        while (aux != null) {
            ...
            if (aux.getValue() == value) {
                ...
                // Si el valor est� a la izquierda del nodo que estamos recorriendo
                ...
                // Si el valor est� a la derecha del nodo que estamos recorriendo
